...
class Cars extends Transport
{
    ...
    {
        $base =  parent::getTransportInfo(); // TODO: Change the autogenerated stub
        $base .= "{$this->fuel}";
        return $base;
    }
...
$cars = new Cars('BMW',1000,'Sport-car ',350,' muscle ');
